...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~order-order-module~product-product-module"], {
  ...
  /***/
  function srcAppProductProductFormComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _product_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! ./product.service */
    ...
    function ProductFormComponent_mat_option_21_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function ProductFormComponent_mat_error_25_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function ProductFormComponent_mat_error_29_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-error");
    ...
    function ProductFormComponent_mat_error_33_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-error");
    ...
    function ProductFormComponent_div_34_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var ProductFormComponent = /*#__PURE__*/function () {
      function ProductFormComponent(fb, route, router, productService, breakpointObserver) {
        var _this = this;
        ...
        this.product = {};
        this.fieldColspan = 4; // Use with the generic validation messageId class
      ...
      _createClass(ProductFormComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.productForm = this.fb.group({
            productName: ["", [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].minLength(3), _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].maxLength(100)]],
        ...
        value: function ngAfterViewInit() {
          ...
          (_rxjs_Observable__WEB = rxjs_Observable__WEBPACK_IMPORTED_MODULE_5__["Observable"]).merge.apply(_rxjs_Observable__WEB, [this.productForm.valueChanges].concat(_toConsumableArray(controlBlurs))).debounceTime(800).subscribe(function () {
            _this3.displayMessage = _this3.genericValidator.processMessages(_this3.productForm);
          });
        }
      }, {
        key: "getProduct",
        value: function getProduct(id) {
          ...
          this.productService.getProduct(id).subscribe(function (product) {
            return _this4.onProductRetrieved(product);
          }, function (error) {
        ...
        value: function getCategories() {
          ...
          this.productService.getCategories().subscribe(function (categories) {
            return _this5.categories = categories;
          }, function (error) {
        ...
        value: function onProductRetrieved(product) {
          ...
          if (this.product.id === 0) {
            ...
            this.pageTitle = "Update Product: ".concat(this.product.productName, " ");
    ...
    ProductFormComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 35,
      vars: 15,
      consts: [["novalidate", "", 3, "formGroup", "ngSubmit"], [2, "background-color", "#FFF"], [1, "view-card-title"], [1, "title-spacer"], ["mat-mini-fab", "", "type", "submit", 1, "primary", 2, "margin-right", "10px", "background-color", "darkgray", 3, "disabled"], ["mat-mini-fab", "", 1, "", 2, "margin-right", "10px", 3, "routerLink"], [2, "margin", "5 0 5 0px"], [1, "form-card"], ["cols", "12", "rowHeight", "80px"], [3, "colspan"], ["appearance", "outline", 1, "form-field"], ["placeholder", "Select Category", "formControlName", "categoryId", 3, "value", "valueChange"], ["categoryIdId", ""], [3, "value", 4, "ngFor", "ngForOf"], ["matInput", "", "id", "productNameId", "type", "text", "placeholder", "Product Name (required)", "formControlName", "productName"], [4, "ngIf"], ["matInput", "", "id", "unitPriceId", "type", "currency", "placeholder", "Price (required)", "formControlName", "unitPrice"], ["matInput", "", "id", "unitInStockId", "type", "number", "placeholder", "Quantity In Stock (required)", "formControlName", "unitInStock"], ["class", "has-error", 4, "ngIf"], [3, "value"], [1, "has-error"]],
      template: function ProductFormComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("valueChange", function ProductFormComponent_Template_mat_select_valueChange_19_listener($event) {
  ...
  /***/
  function srcAppProductProductGuardServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ProductEditGuard", function () {
    ...
    var ProductDetailGuard = /*#__PURE__*/function () {
      ...
      _createClass(ProductDetailGuard, [{
        ...
        value: function canActivate(route) {
          ...
          if (isNaN(id) || id < 1) {
            alert('Invalid product Id'); // start a new navigation to redirect to list pcustomerId

            this.router.navigate(['/products']); // abort current navigation
    ...
    var ProductEditGuard = /*#__PURE__*/function () {
      function ProductEditGuard() {
        _classCallCheck(this, ProductEditGuard);
      }

      _createClass(ProductEditGuard, [{
        key: "canDeactivate",
        value: function canDeactivate(component) {
          if (component.productForm.dirty) {
            var productName = component.productForm.get('productName').value || 'New Product';
            return confirm("Navigate away and lose all changes to ".concat(productName, "?"));
          }
    ...
    ProductEditGuard.ɵfac = function ProductEditGuard_Factory(t) {
      return new (t || ProductEditGuard)();
    };

    ProductEditGuard.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
      token: ProductEditGuard,
      factory: ProductEditGuard.ɵfac
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ProductEditGuard, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"]
      }], null, null);
    })();
    /***/
  ...
  function srcAppProductProductListComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function ProductListComponent_mat_header_cell_26_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function ProductListComponent_mat_cell_27_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function ProductListComponent_mat_header_cell_29_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-header-cell", 35);
    ...
    function ProductListComponent_mat_cell_30_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-cell");
    ...
    function ProductListComponent_mat_header_cell_32_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-header-cell", 35);
    ...
    function ProductListComponent_mat_cell_33_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-cell");
    ...
    function ProductListComponent_mat_header_cell_35_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-header-cell", 35);
    ...
    function ProductListComponent_mat_cell_36_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-cell");
    ...
    function ProductListComponent_mat_header_cell_38_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var _c0 = function _c0(a1) {
      return ["/products/edit", a1];
    };

    function ProductListComponent_mat_cell_39_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ProductListComponent_mat_cell_39_Template_button_click_4_listener() {
          ...
          return ctx_r23.openDialog(product_r22.id);
        });
    ...
    function ProductListComponent_mat_header_row_40_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "mat-header-row");
      }
    }

    function ProductListComponent_mat_row_41_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var ProductListComponent = /*#__PURE__*/function () {
      function ProductListComponent(productService, // private pagerService: PagerService,
      dialog, snackBar) {
      ...
      _createClass(ProductListComponent, [{
        ...
        key: "freshDataList",
        value: function freshDataList(products) {
          this.products = products;
          this.productList = products.map(function (e) {
            var product = e;
        ...
        key: "getProducts",
        value: function getProducts(pageNum) {
          var _this9 = this;

          this.productService.getProducts().subscribe(function (products) {
            _this9.freshDataList(products);
          }, function (error) {
        ...
        key: "searchProducts",
        value: function searchProducts(filters) {
          var _this10 = this;

          if (filters) {
            this.productService.getProducts().subscribe(function (products) {
              _this10.products = products;
              console.log(_this10.products.length);
              _this10.products = _this10.products.filter(function (product) {
                var match = true;
                Object.keys(filters).forEach(function (k) {
                  match = match && filters[k] ? product[k] && product[k].toLocaleLowerCase().indexOf(filters[k].toLocaleLowerCase()) > -1 : match;
                });
                return match;
              });

              _this10.freshDataList(products);
            }, function (error) {
        ...
        value: function openDialog(id) {
          ...
          dialogRef.afterClosed().subscribe(function (result) {
            ...
            if (_this11.selectedOption === dialogRef.componentInstance.ACTION_CONFIRM) {
              _this11.productService.deleteProduct(id).subscribe(function () {
                _this11.productService.getProducts().subscribe(function (products) {
                  _this11.freshDataList(products);
                }, function (error) {
    ...
    ProductListComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function ProductListComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ProductListComponent_Template_button_click_13_listener() {
            return ctx.reset();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("keyup", function ProductListComponent_Template_input_keyup_20_listener($event) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function ProductListComponent_Template_input_ngModelChange_55_listener($event) {
            return ctx.searchFilter.productName = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function ProductListComponent_Template_input_ngModelChange_58_listener($event) {
            return ctx.searchFilter.price = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function ProductListComponent_Template_input_ngModelChange_61_listener($event) {
            return ctx.searchFilter.quantity = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ProductListComponent_Template_button_click_66_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r26);

            var _r14 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](45);

            ctx.searchProducts(ctx.searchFilter);
            return _r14.toggle();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ProductListComponent_Template_button_click_70_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r26);

            var _r14 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](45);

            return ctx.resetSearchFilter(_r14);
          });
      ...
      pipes: [_angular_common__WEBPACK_IMPORTED_MODULE_19__["CurrencyPipe"], _angular_common__WEBPACK_IMPORTED_MODULE_19__["DecimalPipe"]],
  ...
  function srcAppProductProductModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _product_guard_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./product-guard.service */
    "./src/app/product/product-guard.service.ts");
    /* harmony import */
    ...
    ProductModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      ...
      imports: [[_shared_shared_module__WEBPACK_IMPORTED_MODULE_7__["SharedModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["ReactiveFormsModule"], _shared_material_module__WEBPACK_IMPORTED_MODULE_8__["MaterialModule"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild([{
        path: "",
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](ProductModule, {
         ...
         */
        _product_list_component__WEBPACK_IMPORTED_MODULE_3__["ProductListComponent"], _product_form_component__WEBPACK_IMPORTED_MODULE_5__["ProductFormComponent"]],
        imports: [_shared_shared_module__WEBPACK_IMPORTED_MODULE_7__["SharedModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["ReactiveFormsModule"], _shared_material_module__WEBPACK_IMPORTED_MODULE_8__["MaterialModule"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"]],
        exports: [_product_list_component__WEBPACK_IMPORTED_MODULE_3__["ProductListComponent"], _product_form_component__WEBPACK_IMPORTED_MODULE_5__["ProductFormComponent"]]
      });
    })();
    /*@__PURE__*/
  ...
  function srcAppProductProductServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ProductService = /*#__PURE__*/function () {
      function ProductService(http, backend) {
      ...
      _createClass(ProductService, [{
        ...
        value: function getProducts() {
          ...
          var action = "".concat(this.basicAction, "?_expand=category");
        ...
        value: function getProduct(id) {
          ...
          ;
          var action = "".concat(this.basicAction).concat(id, "?_expand=category");
          return this.backend.getByQuery(action).map(this.extractData) // .do(data => console.log('getProduct: ' + JSON.stringify(data)))
        ...
        value: function createProduct(product) {
          product.id = null;
          return this.backend.create(this.basicAction, product).map(this.extractData)["catch"](this.handleError);
        }
      }, {
        key: "updateProduct",
        value: function updateProduct(product) {
          var action = "".concat(this.basicAction).concat(product.id);
          return this.backend.update(action, product).map(function () {
            return product;
          })["catch"](this.handleError);
        }
      }, {
    ...
    ProductService.ɵfac = function ProductService_Factory(t) {
      return new (t || ProductService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HttpClient"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_services__WEBPACK_IMPORTED_MODULE_8__["BackendService"]));
    };
